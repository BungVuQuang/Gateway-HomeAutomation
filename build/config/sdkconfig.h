...
#define CONFIG_BLE_MESH_WAIT_FOR_PROV_MAX_DEV_NUM 1
...
#define CONFIG_BLE_MESH_PROVISIONER_RECV_HB 1
#define CONFIG_BLE_MESH_PROVISIONER_RECV_HB_FILTER_SIZE 3
...
#define CONFIG_MQTT_TASK_PRIORITY 1
